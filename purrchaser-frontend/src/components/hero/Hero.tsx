        ...
        <section className="">
            <div className="relative pt-10 bg-black">
                <div>
                    ...
                    <Image src="/assets/images/HeroPattern.jpg" className="opacity-10 object-cover object-top" fill
                           alt="Dots pattern overlay"/>
                    <Image src="/assets/ND_Graphics_Textures_DomeGuild/Digital/PNG/Dome_Guild_Gold_RGB.png"
                           className="opacity-10 object-cover object-top -translate-x-1/4 " fill
                           alt="Notre Dame grid pattern texture"/>
                </div>
                ...
                <div className="relative pt-5 flex flex-col text-center justify-center">
                    <p className="mx-auto space-x-2 font-display text-base text-slate-900">
                        ...
                        <span className="text-indigo-700"><a><span
                            className="text-xl">👉🏾</span> Stay informed</a></span>
                    </p>
                </div>
            </Container>
        </section>
